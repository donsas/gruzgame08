...
/**
 * @title GruzGame08Onchain
 * @notice Tap + 2-minute check-in game for Base (deploy via Remix on Base Mainnet).
 *         Builder attribution is appended in tx calldata on the client (ERC-8021 suffix), not enforced here.
 */
contract GruzGame08Onchain {
